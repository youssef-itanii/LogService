...
class LogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddLog = channel.unary_unary(
                '/hipstershop.LogService/AddLog',
                request_serializer=demo__pb2.AddLogRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                )
        self.GetLog = channel.unary_unary(
                '/hipstershop.LogService/GetLog',
                request_serializer=demo__pb2.GetLogRequest.SerializeToString,
                response_deserializer=demo__pb2.Empty.FromString,
                )
...
def add_LogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddLog': grpc.unary_unary_rpc_method_handler(
                    servicer.AddLog,
                    request_deserializer=demo__pb2.AddLogRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
            'GetLog': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLog,
                    request_deserializer=demo__pb2.GetLogRequest.FromString,
                    response_serializer=demo__pb2.Empty.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.LogService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class LogService(object):
    ...
    def AddLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.LogService/AddLog',
            demo__pb2.AddLogRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.LogService/GetLog',
            demo__pb2.GetLogRequest.SerializeToString,
            demo__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
